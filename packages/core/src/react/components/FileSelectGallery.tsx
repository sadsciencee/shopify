...
import type { FileSearchNode, LocalFile } from "./FileContext";
import { filenameFromPreviewUrl } from "@ucoast/shared";
        ...
        >
            {url ? (
                <Image
                    ...
                    width={"100%"}
                    height={"100%"}
                    style={{ display: "block", objectFit: 'cover', width: '100%', height: '100%', aspectRatio: '1' }}
                />
            ) : (
                <div
                    style={{
